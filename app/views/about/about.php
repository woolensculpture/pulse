		<div id="about_wrap" class="border general_wrap">
	        <div class="about_section">
	            <p class="large_header about_header">The Station</p>
		            <p>WITR 89.7 is a collaborative radio station run by students with a love of music 
		            ...
		            <p>WITR is fueled by passion. Our students pride themselves on being a
	        ...
	        <div class="about_section" id="about_center">
	            <p class="large_header about_header">The Music</p>
	            <p> WITR strives to be the best student-run and operated radio station in the
	        ...
	        <div class="about_section">
	            <p class="large_header about_header">Community &amp; Culture</p>
	            	<p>WITR is a family of hard-working and diverse students. It breeds leaders with 
		    ...
		    <div style="text-align:center"> <a href="<?php echo base_url(); ?>static/eeoWITR.pdf"> WITR is an Equal Employment Opportunity organization </a> </div>
		</div>
